      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto" data-testid="text-features-subtitle" itemProp="description">
            Complete enterprise AI agent platform with semantic search, OAuth 2.0 security, cross-framework support for LangChain, CrewAI, ADK, HF and other agents, federation capabilities, and production-ready deployment for intelligent agent discovery and collaboration.
          </p>
        </header>
